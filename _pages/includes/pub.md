...
- OS-Copilot is built to power the development of self-evolving computer agents.

- Check demos at [**Our Website**](https://os-copilot.github.io/) and [**Code** ![](https://img.shields.io/github/stars/OS-Copilot/OS-Copilot?style=social)](https://github.com/OS-Copilot/OS-Copilot). 
...
- ``Preprint`` [A Survey of Neural Code Intelligence: Paradigms, Advances and Beyond](https://arxiv.org/abs/2403.14734) 🔥 Qiushi Sun, Zhirui Chen, Fangzhi Xu, ..., **Zhiyong Wu**. [![](https://img.shields.io/github/stars/QiushiSun/NCISurvey?style=social&label=Code+Stars)](https://github.com/QiushiSun/NCISurvey)
...
- ``Preprint`` [SeeClick: Harnessing GUI Grounding for Advanced Visual GUI Agents](https://arxiv.org/abs/2311.09278), Kanzhi Cheng, Qiushi Sun, Yougang Chu, Fangzhi Xu, Yantao Li, Jianbing Zhang, **Zhiyong Wu**. [![](https://img.shields.io/github/stars/njucckevin/SeeClick?style=social&label=Code+Stars)](https://github.com/njucckevin/SeeClick)
- ``Preprint`` [Symbol-LLM: Towards Foundational Symbol-centric Interface For Large Language Models](https://arxiv.org/abs/2311.09278), Fangzhi Xu, **Zhiyong Wu**, et al.
